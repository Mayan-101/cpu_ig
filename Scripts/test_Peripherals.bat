...
echo Running Peripherals Tests (with System Integration)...
iverilog -o test_peri.vvp Tests/tb_peripherals.v SystemTests/system_top.v %PERI_CORE% %MEM_CORE% %PIPE_CORE% %ALU_CORE% %REG_CORE%
if %errorlevel% equ 0 (vvp test_peri.vvp && del test_peri.vvp)
pause
