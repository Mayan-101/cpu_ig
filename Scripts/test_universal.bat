...
iverilog -g2012 -o universal_sim.vvp SystemTests/tb_universal.v SystemTests/system_cache_top.v ^
    ...
    Pipeline/cpu_top.v Pipeline/pc_reg.v Pipeline/pipeline_reg.v Pipeline/control_unit.v ^
    ...
    Peripherals/io_peripheral_bus.v Peripherals/gpio.v Peripherals/timer.v Peripherals/uart.v ^
