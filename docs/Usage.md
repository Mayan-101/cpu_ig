...
3.  **Run**: Use the automated script:
    ```powershell
    .\Scripts\test_prgram.bat <program_name>
    ```

### Example
To test bubble sort with your own data:
1.  Put your hex values in `Programs/ram_init.mem`.
2.  Run: `.\Scripts\test_prgram.bat bubble_sort`

### Script Parameters
`.\Scripts\test_prgram.bat <name> [dump_start] [dump_end] [hex_mode]`
...
### Example Commands
- **Basic Run**: `.\Scripts\test_prgram.bat bubble_sort 0 10 0`
- **Matrix Multiplication (Hex Mode)**: `.\Scripts\test_prgram.bat matmul 0 32 1`
